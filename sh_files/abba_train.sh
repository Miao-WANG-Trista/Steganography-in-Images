export DATA_ROOT_PATH=./Test_images/nsf5/
...
# python3 train_module/train_pytorch.py --model mixnet_s --experiment mixnet_S_R --fp16 0 --decoder R --batch-size 16
python3 train_module/train_pytorch.py --model mixnet_s --experiment mixnet_S_NR_mish --batch-size 32
python3 train_module/train_pytorch.py --model mixnet_xl --experiment mixnet_xL_NR_mish --batch-size 32
# python3 train_module/train_pytorch.py --model efficientnet-b2 --experiment efficientnet_b2_R --fp16 0 --decoder R --batch-size 16
python3 train_module/train_pytorch.py --model efficientnet-b2 --experiment efficientnet_b2_NR_mish --batch-size 32
python3 train_module/train_pytorch.py --model efficientnet-b4 --experiment efficientnet_b4_NR_mish --batch-size 32
python3 train_module/train_pytorch.py --model efficientnet-b5 --experiment efficientnet_b5_NR_mish --batch-size 32
# python3 train_module/train_pytorch.py --model efficientnet-b6 --experiment efficientnet_b6_NR_mish --batch-size 29
...
# mpirun -np 2 -H localhost:2 -bind-to none -map-by slot -x NCCL_DEBUG=INFO -x LD_LIBRARY_PATH -x PATH -mca pml ob1 -mca btl ^openib -mca plm_rsh_args "-p 22" python3 train_module/train_tf.py
...
# horovodrun -np 2 -H localhost:2 python3 train_module/train_tf.py --warm-start-checkpoint --quality-factor 75 --pair-constraint 0 --lr-schedule-id 2
# horovodrun -np 2 -H localhost:2 python3 train_module/train_tf.py --warm-start-checkpoint --quality-factor 95 --pair-constraint 0 --lr-schedule-id 2
# horovodrun -np 2 -H localhost:2 python3 train_module/train_tf.py --warm-start-checkpoint --quality-factor 90 --pair-constraint 0 --lr-schedule-id 2
